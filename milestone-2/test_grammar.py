...
@pytest.mark.parametrize("code_snippet, expected_return_code", [
    ("void main() {", 1),
...
def test_compilation_unit_main_identifier_check(code_snippet: str, expected_return_code: int) -> None:
...
@pytest.mark.parametrize("code_snippet", [
    ...
    """ class Cheese { private int amazing_method() {} static private int amazing_method2() {} }""" + main,
    """ class Cheese { public char amazing_method(int x, char y, bool e) {} } """ + main,
])
...
# -- METHOD DECLARATION --
@pytest.mark.parametrize("code_snippet", [
    """ class Cheese { static! public int sad_method() {} public int amazing_method() {} } """ + main,
...
@pytest.mark.parametrize("code_snippet", [
    ...
    """ class SomeAmazingClass { static private string favString = "This is awesome!"; } """ + main,
])
...
@pytest.mark.parametrize("code_snippet", [
    ...
    """class SomeAmazingClass { SomeAmazingClass() {} SomeAmazingClass() {} }""" + main,
    """class SomeAmazingClass { SomeAmazingClass(int[] x, char y, bool e) {} }""" + main,
])
...
@pytest.mark.parametrize("code_snippet", [
    ...
    """class cheddar {private int x = 4 + 4; private char k = 'k'; private string side_dish = "beaan";}""" + main,
    """class PepperJack {public int x = 4 + 4; public char y = 'a';}""" + main,
    """class ColbyJack {private int x = 4 + 4; public int y = 4 + 4; private int z = 4 + 4; public int a = 4 + 4; private int b = 4 + 4;}""" + main,
])
